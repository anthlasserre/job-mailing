          ...
          <div class="panel-body" style="padding-left:50px;padding-right:50px">
               ...
               <form action = "" method = "post" class="form-horizontal">
                 <fieldset>
                  ...
                  <input type="text" name="user_name" class="form-control input-sm" id="inputSmall" placeholder="utilisateur.."/><br /><br />
                  <label class="control-label" for="inputPassword">Mot de passe  : </label>
                  <input type = "password" name="user_pass" class="form-control" id="inputPassword" placeholder="mot de passe.."/><br/><br />
